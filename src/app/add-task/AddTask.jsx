  ...
  return (
    <div className="grid grid-cols-12 justify-center mt-10 mb-10">
      ...
      <form
        ...
        className="border-2 border-white-500 p-5 col-span-4 col-start-5">
        ...
        <h1 className="text-2xl flex justify-center">Add your Task</h1>
        ...
        <div>
          ...
          <input
            ...
            type="text"
            id="add-task"
            className="w-full bg-gray-700 focus:ring-blue-500 rounded-xl outline outline-offset-2 outline-white p-2"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleInputChange}
            id="task-description"
            className="bg-gray-700 focus:ring-blue-500 rounded-xl outline outline-offset-2 outline-white w-full p-2"></textarea>
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={handleInputChange}
            id="task-status"
            className="bg-gray-700 focus:ring-blue-500 rounded-xl outline outline-offset-2 outline-white w-full p-2">
